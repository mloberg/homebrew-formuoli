class DnsmasqDnssec < Formula
    desc "Lightweight DNS forwarder and DHCP server with DNSSEC support"
    ...
    conflicts_with "dnsmasq", :because => "replaces dnsmasq"
    ...
    def install
      ...
      pkgshare.install "trust-anchors.conf"
